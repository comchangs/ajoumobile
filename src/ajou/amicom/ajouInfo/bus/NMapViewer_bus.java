 ...
 * @author kyjkim
 */
public class NMapViewer_bus extends NMapActivity {
	...
	private static final NGeoPoint NMAP_LOCATION_DEFAULT = new NGeoPoint(127.0427546, 37.2778514);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bus_naver);
		...
		alert_internet_status
				.setMessage("지도모드  및 GPS이용은 메뉴 버튼을 누르시면 가능합니다.\nGPS의 경우 두번 누르시면 지도가 방위에 맞추어 회전됩니다.");
	...
	protected void onDestroy() {
		...
		mMapController.setMapCenter(new NGeoPoint(127.0427546, 37.2778514), 11);
		saveInstanceState();
		...
		if (mMyLocationOverlay != null) {
			...
			if (mMapLocationManager.isMyLocationEnabled()) {
				...
				if (!isMyLocationEnabled) {
					Toast.makeText(NMapViewer_bus.this, "Please enable a My Location source in system settings",
	...
	private void testPOIdataOverlay() {
		...
		poiData.beginPOIdata(15);
		poiData.addPOIitem(127.0397839, 37.2822206, "03117 효성초등학교", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0394179, 37.2821111, "03119 효성초등학교", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0420764, 37.2808684, "03124 유신고등학교", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0419367, 37.2806561, "03125 유신고등학교", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0469256, 37.2782866, "04039 아주대병원", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0471025, 37.2779357, "04041 아주대병원", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0439007, 37.2785859, "04237 아주대정문", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0436193, 37.2784902, "03126 아주대정문", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0440798, 37.2760177, "04238 아주대입구", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0438109, 37.2757192, "03129 아주대입구", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0422561, 37.2754112, "03132 아주대입구삼거리", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.044462, 37.2743651, "04023 아주대입구삼거리", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.042021, 37.2751263, "04208 구매탄시장", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0472733, 37.2739162, "04042 법원사거리", markerId, 0).setRightButton(true);
		poiData.addPOIitem(127.0465355, 37.2737466, "04179 법원사거리", markerId, 0).setRightButton(true);
		poiData.endPOIdata();
	...
	private final NMapActivity.OnDataProviderListener onDataProviderListener = new NMapActivity.OnDataProviderListener() {
		...
		public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
			...
			if (errInfo != null) {
				...
				Toast.makeText(NMapViewer_bus.this, errInfo.toString(), Toast.LENGTH_LONG).show();
				return;
			}
	...
	private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
		...
		public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
			...
			Toast.makeText(NMapViewer_bus.this, "Your current location is temporarily unavailable", Toast.LENGTH_LONG).show();
		}
	...
	private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
		...
		public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
			...
			if (errorInfo == null) { // success
				...
				Toast.makeText(NMapViewer_bus.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
			}
		}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
			...
			Intent intent = new Intent(NMapViewer_bus.this, busView.class);
			intent.putExtra("busdata", item.getTitle().substring(0, 5));
			startActivity(intent);
			//Toast.makeText(NMapViewer_bus.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
			...
			if (itemOverlay instanceof NMapPOIdataOverlay) {
				...
				if (!poiDataOverlay.isFocusedBySelectItem()) {
					...
					if (countOfOverlappedItems > 1) {
						...
						Toast.makeText(NMapViewer_bus.this, "지도를 확대하여 정류장을 정확히 클릭해주세요!", Toast.LENGTH_LONG).show();
						return null;
					}
				}
			}
	...
	private static final int MENU_ITEM_BUILDING_10 = MENU_ITEM_BUILDING + 0;
