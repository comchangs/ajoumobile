...
public class food extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        category = URLEncoder.encode((String) extras.get("category"));
	...
	private void dbXml() {
		...
		try{
        	URL text = new URL( "http://dev.jwnc.net/ajoumobile/food.php?category="+category+"&first="+i );
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(food.this, foodView.class);
