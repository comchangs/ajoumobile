...
public class phone_tab1 extends Activity {
	...
	class GetDataFromServer extends AsyncTask<Integer, Integer, MemberAdapter>{
		...
		protected MemberAdapter doInBackground(Integer... params) {
			...
			String url = "http://dev.jwnc.net/ajoumobile/phone_json.php?big_type=%EB%8C%80%ED%95%99/%EB%8C%80%ED%95%99%EC%9B%90";
		...
		protected void onPostExecute(final MemberAdapter adapter) {
			...
			list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,	int arg2, long arg3) {
					...
					Intent intent = new Intent(phone_tab1.this, phone_View.class);
