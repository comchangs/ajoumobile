...
import ajou.amicom.ajouInfo.phone.phone_tab1.*;
...
public class phone_tab2 extends Activity {
	Context context;
	@Override
	...
	class GetDataFromServer extends AsyncTask<Integer, Integer, MemberAdapter>{
		...
		protected MemberAdapter doInBackground(Integer... params) {
			...
			String url = "http://dev.jwnc.net/ajoumobile/phone_json.php?big_type=%EC%97%B0%EA%B5%AC/%ED%96%89%EC%A0%95%EA%B8%B0%EA%B4%80";
		...
		protected void onPostExecute(final MemberAdapter adapter) {
			...
			list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,	int arg2, long arg3) {
					...
					Intent intent = new Intent(phone_tab2.this, phone_View.class);
