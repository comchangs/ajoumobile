...
public class phone_tab3 extends Activity {
	Context context;
	@Override
	...
	class GetDataFromServer extends AsyncTask<Integer, Integer, MemberAdapter>{
		...
		protected MemberAdapter doInBackground(Integer... params) {
			...
			String url = "http://dev.jwnc.net/ajoumobile/phone_json.php?big_type=%EC%A7%80%EC%9B%90%EA%B8%B0%EA%B4%80/%EA%B8%B0%ED%83%80";
		...
		protected void onPostExecute(final MemberAdapter adapter) {
			...
			list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,	int arg2, long arg3) {
					...
					Intent intent = new Intent(phone_tab3.this, phone_View.class);
