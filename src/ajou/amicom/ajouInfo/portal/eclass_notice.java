...
public class eclass_notice extends Activity {
	Context context;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eclass_notice);
		context = this;
			...
			list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					AlertDialog.Builder alert_internet_status = new AlertDialog.Builder(
							eclass_notice.this);
					alert_internet_status.setTitle("이클래스 공지사항");
	...
	String DownloadXML() {
		...
		try {
			...
			String parameter = null;
			parameter = new String(
					"taskId=F_STU_MAIN&sysType=ECLS&clubId=ECLS_MAIN&menuCode=1005&menuNo=1&flag=class&page=2");
